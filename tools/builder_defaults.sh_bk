...
DEVELOPMENT_HOSTNAME=${DEVELOPMENT_HOSTNAME:-"52.59.151.216"}
...
export PKG_RSYNC_DESTDIR=${PKG_RSYNC_DESTDIR:-"/usr/local/poudriere/data/packages/AIS_RELEASE"}
...
if [ -n "${_IS_RELEASE}" ]; then
	...
	export PKG_FINAL_RSYNC_DESTDIR=${PKG_FINAL_RSYNC_DESTDIR:-"/usr/local/poudriere/data/packages/AIS_RELEASE"}
else
	export PKG_FINAL_RSYNC_HOSTNAME=${PKG_FINAL_RSYNC_HOSTNAME:-${STAGING_HOSTNAME}}
	export PKG_FINAL_RSYNC_DESTDIR=${PKG_FINAL_RSYNC_DESTDIR:-"/usr/local/poudriere/data/packages/AIS_DEVELOPMENT"}
fi
